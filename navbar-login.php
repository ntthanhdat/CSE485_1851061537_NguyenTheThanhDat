      ...
      <!-- Modal register-->
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                ...
                <form action="controller/process-register.php" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                        <label for="">Your first name</label>
                        <input type="text" name="f_name" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
                        </div>
                        <div class="form-group">
                        <label for="">Your last name</label>
                        <input type="text" name="l_name" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="password" name="password1" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
                        </div>
                        <div class="form-group">
                        <label for="">Confirm password</label>
                        <input type="password" name="password2" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
                        </div>
                    </div>
